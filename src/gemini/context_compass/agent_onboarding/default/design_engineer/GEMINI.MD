...
# GEMINI.MD - Design Engineer Contract
...
- `agent_onboarding/default/general/GEMINI.MD`
- `agent_onboarding/default/engineer/GEMINI.MD`
...
- If the user requested "design then implement":
  - get explicit design approval review before editing code.
